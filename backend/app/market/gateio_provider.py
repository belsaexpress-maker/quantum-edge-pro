...
GATEIO_URL = "https://api.gateio.ws/api/v4/spot/tickers"


def get_gateio_usdt_markets(limit: int = 500):
    try:
        response = requests.get(GATEIO_URL, timeout=12)
